...
public abstract class LocationAppCompatActivity extends AppCompatActivity implements OnLocationChangeListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 5319) {
            PermissionHandlerHelper.onRequestPermissionsResultHelper(LocationAppCompatActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.PermissionResultResponse() {
                @Override
    ...
    protected final void startLocationService() {
        PermissionHandlerHelper.checkPermissionHelper(LocationAppCompatActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.CheckPermissionResponse() {
            @Override
            public void permissionGranted() {
                setupGPS();
            }
    ...
    private void getLatLong() {
        if (fusedLocationApiService == null) {
            fusedLocationApiService = new FusedLocationApiService(LocationAppCompatActivity.this, LocationAppCompatActivity.this);
    ...
    private void initialiseGpsTracker() {
        mGpsTracker = new GPSTracker(LocationAppCompatActivity.this);
