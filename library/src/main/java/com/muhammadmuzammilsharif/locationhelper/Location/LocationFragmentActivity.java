...
public abstract class LocationFragmentActivity extends FragmentActivity implements OnLocationChangeListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 5319) {
            PermissionHandlerHelper.onRequestPermissionsResultHelper(LocationFragmentActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.PermissionResultResponse() {
                @Override
    ...
    protected final void startLocationService() {
        PermissionHandlerHelper.checkPermissionHelper(LocationFragmentActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.CheckPermissionResponse() {
            @Override
            public void permissionGranted() {
                setupGPS();
            }
    ...
    private void getLatLong() {
        if (fusedLocationApiService == null) {
            fusedLocationApiService = new FusedLocationApiService(LocationFragmentActivity.this, LocationFragmentActivity.this);
    ...
    private void initialiseGpsTracker() {
        mGpsTracker = new GPSTracker(LocationFragmentActivity.this);
