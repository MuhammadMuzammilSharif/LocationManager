...
/**
 * did something in old style
 *
 * @deprecated use {@link LocationAppCompatActivity } or
 * {@link LocationFragmentActivity} or
 * {@link LocationBaseActivity}
 */

@Deprecated
public abstract class LocationActivity extends AppCompatActivity implements OnLocationChangeListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 5319) {
            PermissionHandlerHelper.onRequestPermissionsResultHelper(LocationActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.PermissionResultResponse() {
                @Override
    ...
    protected final void startLocationService() {
        PermissionHandlerHelper.checkPermissionHelper(LocationActivity.this, LOCATION_PERMISSION, new PermissionHandlerHelper.CheckPermissionResponse() {
            @Override
            public void permissionGranted() {
                setupGPS();
            }
    ...
    private void getLatLong() {
        if (fusedLocationApiService == null) {
            fusedLocationApiService = new FusedLocationApiService(LocationActivity.this, LocationActivity.this);
    ...
    private void initialiseGpsTracker() {
        mGpsTracker = new GPSTracker(LocationActivity.this);
